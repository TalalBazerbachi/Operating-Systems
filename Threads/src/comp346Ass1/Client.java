...
public class Client implements Runnable { 
    ...
    {   
    	...
    	boolean sending=clientOperation.contentEquals("sending");
    	boolean receiving=clientOperation.contentEquals("receiving");
...
//			Thread.yield();
    	...
    	//check time taken to receive transaction:
    	if(receiving) {
    		receiveClientStartTime=System.currentTimeMillis();
    		receiveTransactions(transact);
    		objNetwork.disconnect(objNetwork.getClientIP());
    		receiveClientEndTime=System.currentTimeMillis();
    		receiveTime=receiveClientEndTime-receiveClientStartTime;
    		System.out.println("-----the client thread for receiving is finishing. The elapsed time is:"+receiveTime+" milliseconds-----");		
    	}
    	
    	//check time taken to send transaction:
    	else if(sending) {
    		sendClientStartTime=System.currentTimeMillis();
    		sendTransactions();
    	
    		sendClientEndTime=System.currentTimeMillis();
    		sendTime=sendClientEndTime-sendClientStartTime;
    		System.out.println("-----the  thread for sending is finishing. The elapsed time is: "+sendTime+" milliseconds----");	
    	}
